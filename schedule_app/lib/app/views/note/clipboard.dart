...
class ClipboardService {
  static Future<void> setData(ClipboardServiceData data) async {
  ...
  static Future<void> setPlainText(String text) async {
    await SystemClipboard.instance?.write([
      DataWriterItem()..add(Formats.plainText(text)),
    ]);
  }

  static Future<ClipboardServiceData> getData() async {

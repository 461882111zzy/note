        ...
        final label = HoverButton(
          ...
          builder: (context, states) {
            ...
            return DefaultTextStyle.merge(
              style: TextStyle(color:states.isNone?foregroundColor: FluentTheme.of(context).accentColor),
              child: IconTheme.merge(
                data: IconThemeData(color: states.isNone?foregroundColor: FluentTheme.of(context).accentColor),
                child: item.label,
              ),
            );
          },
